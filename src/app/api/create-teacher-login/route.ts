  ...
  try {
    ...
    if (teacherSnap.empty) {
      return NextResponse.json(
        { error: 'No teacher record found with this email in your college' },
        { status: 404 }
      );
    }
    ...
    try {
      ...
      try {
        ...
        return NextResponse.json({
          ...
          skipped: false,
          email,
          message: `Teacher login created. Sign in with this email and default password ${DEFAULT_NEW_USER_PASSWORD}.`,
        });
      } catch (err: unknown) {
