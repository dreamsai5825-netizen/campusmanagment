...
function CollegeAdminAcademicYearSelect() {
  ...
  return (
    <div className="flex items-center gap-2">
      <Label htmlFor="college-admin-academic-year" className="sr-only">
        Academic Year
      </Label>
      <Select value={selectedAcademicYear} onValueChange={setSelectedAcademicYear}>
        <SelectTrigger id="college-admin-academic-year" className="w-[140px] sm:w-[160px]">
      ...
      <Sidebar>
        ...
        <SidebarFooter className="border-t border-sidebar-border">
          <SidebarMenu>
            ...
            <SidebarMenuItem>
              <Link href="/college-admin-dashboard/profile">
                <SidebarMenuButton
                  className="justify-start gap-3"
                  isActive={pathname === '/college-admin-dashboard/profile'}
                >
                  {profileAvatarUrl && (
                    <Image
