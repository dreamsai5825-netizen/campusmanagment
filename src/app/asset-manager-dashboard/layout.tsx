...
const navItems = [
  { href: '/asset-manager-dashboard', icon: LayoutDashboard, label: 'Dashboard' },
  { href: '/asset-manager-dashboard/requests', icon: ClipboardList, label: 'Requests' },
  { href: '/asset-manager-dashboard/inventory', icon: Boxes, label: 'Asset Inventory' },
  { href: '/asset-manager-dashboard/request-management', icon: MessageSquare, label: 'Request Management' },
  { href: '/asset-manager-dashboard/send-asset', icon: Send, label: 'Send Asset' },
...
export default function AssetManagerDashboardLayout({
  ...
  const principal = useCurrentPrincipal(); // Resolves current asset manager
            ...
            <SidebarMenuItem>
              <Link href="/asset-manager-dashboard/profile">
                <SidebarMenuButton
                  ...
                  isActive={pathname === '/asset-manager-dashboard/profile'}
                >
                  {profileAvatarUrl && (
                    <Image
                      src={profileAvatarUrl}
                      alt={principal?.name ?? 'Asset Manager'}
                      width={28}
                      height={28}
